...
import { ChevronRight, Star, Clock, ShieldCheck, Heart, ArrowDown, ShoppingBag, Check, Plus, Minus, Loader2 } from "lucide-react";
          ...
          <button
            ...
            className={`w-full py-2.5 rounded-xl font-semibold text-sm transition-all duration-300 flex items-center justify-center gap-2 ${
              justAdded
                ...
                : "bg-primary/8 border border-primary/20 text-primary hover:bg-primary hover:text-primary-foreground"
            }`}
          >
    ...
    <div className="w-full">
      ...
      <section ref={heroRef} className="relative min-h-screen overflow-hidden flex items-center">
        ...
        <FloatingBadge className="top-36 right-16" delay={1.0}>
          ...
          <div>
            <p className="text-xs font-bold text-foreground">100% Fresh</p>
            <p className="text-[10px] text-foreground/60">Baked Today</p>
          </div>
        </FloatingBadge>
        ...
        <FloatingBadge className="bottom-44 right-24" delay={1.2}>
          <div className="flex -space-x-2">
            {["RS","AM","PK"].map(i => (
              <div key={i} className="w-7 h-7 rounded-full bg-primary/20 border-2 border-white flex items-center justify-center text-[9px] font-bold text-primary">{i}</div>
            ))}
          </div>
          <div>
        ...
        <FloatingBadge className="top-52 right-72" delay={1.4}>
          ...
          <div>
            <p className="text-xs font-bold text-foreground">Custom Cakes</p>
            <p className="text-[10px] text-foreground/60">Order Today</p>
          </div>
        </FloatingBadge>
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 pt-28 pb-24">
          <div className="max-w-2xl">
            ...
            >
              Crafted With<br />
              <span className="italic" style={{ color: "hsl(28 80% 72%)" }}>
                Love & Joy
              </span>
            </motion.h1>
            ...
            <motion.div
              ...
              className="w-16 h-0.5 rounded-full mb-10"
              style={{ background: "hsl(28 80% 65%)" }}
            />
